...
particlesJS('hoge',{
  ...
  //--シェイプの設定----------
        ...
        "size":{
          ...
          "anim":{
            ...
            "speed":1.5, //アニメーションのスピード
            "size_min":0.0001, //大きさの最小値
  ...
  //--マウスオーバー時の処理----------
          "onhover":{
            ...
            "mode":"grub" //マウスオーバー時に発動する動き(下記modes内のgrab、repulse、bubbleより選択)
          },
  //--------------------
